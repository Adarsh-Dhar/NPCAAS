...
export default function ExportModal({ isOpen, onClose }: ExportModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50 p-4">
      {/* Modal Container */}
      <div className="w-full max-w-2xl border-4 border-pink-500 bg-black p-8 shadow-[8px_8px_0px_0px_rgba(236,72,153,1)]">
        {/* Header */}
        <div className="mb-6 pb-4 border-b-4 border-pink-500">
          <h2 className="text-2xl font-bold text-white uppercase">
            INTEGRATE NPC TO GAME ENGINE
          </h2>
          <p className="text-pink-400 text-xs uppercase font-bold mt-2">
            Copy this SDK code to your game project
          </p>
        </div>

        {/* Code Block */}
        <div className="bg-gray-900 border-4 border-cyan-400 p-6 mb-6 overflow-x-auto">
